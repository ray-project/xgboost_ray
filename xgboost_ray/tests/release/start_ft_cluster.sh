...
SESSION_NAME="xgboost_ray_release_ft_$(date +%s)"
...
echo Running: anyscale up --cloud-name anyscale_default_cloud --config cluster_ft.yaml "${SESSION_NAME}"
anyscale up --cloud-name anyscale_default_cloud --config cluster_ft.yaml "${SESSION_NAME}"
